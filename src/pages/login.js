        ...
        <>
            <div className='w-[100vw] h-[100vh] flex items-center login z-[1]'>
                <div className='w-[100%] h-[100%] flex justify-end z-[2] loginbanner bg-cover bg--no-repeat'>
                    <form className='w-[100%] md:w-[40%] h-[100%] flex flex-col justify-center items-center bg-white bg-opacity-30 backdrop-blur-md drop-shadow-lg' onSubmit={loginUser}>
                        <div className='w-[100%] md:w-[70%] mx-auto p-4 rounded-lg flex flex-col gap-4'>
                            ...
                            <div className='flex flex-col gap-1'>
                                ...
                                <input type='text' placeholder={`${errors.email ? errors.email : 'name@gmail.com'}`} name='email' onChange={handleInput} className={`placeholder:text-[${errors.password ? 'var(--red)' : 'var(--green)'}] border-[1px] ease-in-out duration-300 outline-none rounded-lg py-[14px] px-4 placeholder:${errors.password ? 'normal' : 'italic'} placeholder:text-sm w-[100%]`} />
                            ...
                            <button className='rounded-lg py-2 px-3 text-xl cursor-pointer ease-in-out duration-300 bg-[var(--green)] text-[var(--white)] ' type='submit'>Sign In</button>
