    ...
    return (
        <>
            <div className="relative w-[100%] flex flex-col gap-4">
                ...
                {
                    isOpen && (
                        <div className="w-[100%] min-h-[80vh] overflow-scroll h-[100%] pt-8 pb-6 px-4 rounded-md flex flex-col items-start justify-between bg-[var(--green)] popin absolute top-[4rem] z-[9]">
