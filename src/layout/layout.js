...
const Layout = ({ children }) => {
    return (
        <>
            <div className="flex flex-col justify-between items-start lg:flex-row lg:gap-6 lg:p-6 h-[100vh]">
                <nav className="w-[5%] h-[100%] bg-[var(--green)] rounded-xl px-2 py-4 hidden lg:flex">
                    <Navbar />
                </nav>
                <nav className="bg-[var(--white)] w-[100%] flex items-center justify-between p-4 lg:hidden">
                    <MobileNavigation />
                </nav>
